<main class="relative flex-1">
    ...
    <div class="md:grid md:min-h-screen md:grid-cols-2">
        ...
        <div class="flex min-w-0 flex-col md:min-h-screen md:pt-16">
            ...
            <section aria-label="Streaming links" class="w-full px-4 py-6"><h2 class="sr-only">Dengarkan <?= e($site['release']) ?> dari <?= e($site['name']) ?></h2><div class="mx-auto flex max-w-sm flex-col gap-3"><?php foreach ($site['platforms'] as $platform) render('components/dsp-card', compact('site', 'platform')); ?></div></section>
