<main class="relative flex-1">
    ...
    <div class="md:grid md:h-screen md:grid-cols-2">
        <div class="relative flex flex-col md:h-screen md:overflow-hidden">
            <div class="relative aspect-square w-full md:aspect-auto md:min-h-0 md:flex-1"><img src="/images/callii/photo-collage.jpg" alt="CALLII photo collage from the MULAI LAGI era" width="600" height="600" fetchpriority="high" decoding="async" class="absolute inset-0 size-full object-cover md:object-contain"></div>
